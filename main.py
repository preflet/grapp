...
fig = px.line(x=names, y=values, color=px.Constant("This year"),
...
fig_do = go.Figure(data=[go.Pie(labels=label1, values=value1, hole=.3)])
...
#tabs
   html.Div([
    ...
    dcc.Graph(figure=fig),
        style={'width':'90%','border':'2px solid #6d9399','border-radius':'10px','margin-left':'20px'}
    ),
    ...
    html.Div(className='gap'), 
     ...
     html.Div([
    dcc.Graph(figure=fig_do,style={'width':'45%','border':'2px solid #6d9399', 'border-radius':'10px','margin-left':'20px','display':'inline-block'}),
    dcc.Graph(figure=fig4,style={'width':'45%','border':'2px solid #6d9399', 'border-radius':'10px','margin-left':'30px','display':'inline-block'}),
